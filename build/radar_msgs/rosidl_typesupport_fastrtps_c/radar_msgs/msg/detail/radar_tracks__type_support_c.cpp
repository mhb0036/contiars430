...
#include "radar_msgs/msg/detail/radar_tracks__rosidl_typesupport_fastrtps_c.h"
...
#include "radar_msgs/msg/detail/radar_track__functions.h"  // tracks
...
using _RadarTracks__ros_msg_type = radar_msgs__msg__RadarTracks;
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: tracks
  {
    ...
    if (ros_message->tracks.data) {
      radar_msgs__msg__RadarTrack__Sequence__fini(&ros_message->tracks);
    }
...
static uint32_t _RadarTracks__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_radar_msgs__msg__RadarTracks(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = radar_msgs__msg__RadarTracks;
    is_plain =
      (
...
static size_t _RadarTracks__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_radar_msgs__msg__RadarTracks(
