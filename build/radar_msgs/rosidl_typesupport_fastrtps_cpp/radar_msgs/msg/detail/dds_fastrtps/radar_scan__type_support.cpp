...
#include "radar_msgs/msg/detail/radar_scan__rosidl_typesupport_fastrtps_cpp.hpp"
...
{
bool cdr_serialize(
  const radar_msgs::msg::RadarReturn &,
  eprosima::fastcdr::Cdr &);
bool cdr_deserialize(
  eprosima::fastcdr::Cdr &,
  ...
  radar_msgs::msg::RadarScan & ros_message)
{
  ...
  // Member: returns
  {
    ...
    ros_message.returns.resize(size);
    for (size_t i = 0; i < size; i++) {
      radar_msgs::msg::typesupport_fastrtps_cpp::cdr_deserialize(
        cdr, ros_message.returns[i]);
    }
  }
  ...
  // Member: returns
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      current_alignment +=
        ...
        ros_message.returns[index], current_alignment);
    }
  }
  ...
  size_t current_alignment)
{
  ...
  // Member: returns
  {
    ...
    for (size_t index = 0; index < array_size; ++index) {
      ...
      bool inner_is_plain;
      size_t inner_size =
        radar_msgs::msg::typesupport_fastrtps_cpp::max_serialized_size_RadarReturn(
        inner_full_bounded, inner_is_plain, current_alignment);
      last_member_size += inner_size;
      current_alignment += inner_size;
      full_bounded &= inner_full_bounded;
  ...
  if (is_plain) {
    ...
    using DataType = radar_msgs::msg::RadarScan;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const radar_msgs::msg::RadarScan *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<radar_msgs::msg::RadarScan *>(
    untyped_ros_message);
...
{
  return &radar_msgs::msg::typesupport_fastrtps_cpp::_RadarScan__handle;
}
