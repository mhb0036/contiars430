...
static const _RadarReturn_type_support_symbol_names_t _RadarReturn_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, radar_msgs, msg, RadarReturn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, radar_msgs, msg, RadarReturn)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, radar_msgs, msg, RadarReturn)() {
  return &::radar_msgs::msg::rosidl_typesupport_c::RadarReturn_message_type_support_handle;
}
