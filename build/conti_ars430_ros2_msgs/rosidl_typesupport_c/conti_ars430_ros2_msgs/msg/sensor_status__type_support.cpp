...
static const _SensorStatus_type_support_symbol_names_t _SensorStatus_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, conti_ars430_ros2_msgs, msg, SensorStatus)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, conti_ars430_ros2_msgs, msg, SensorStatus)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, conti_ars430_ros2_msgs, msg, SensorStatus)() {
  return &::conti_ars430_ros2_msgs::msg::rosidl_typesupport_c::SensorStatus_message_type_support_handle;
}
