...
class Metaclass_RadarScan(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            if RadarReturn.__class__._TYPE_SUPPORT is None:
                RadarReturn.__class__.__import_type_support__()
...
class RadarScan(metaclass=Metaclass_RadarScan):
    ...
    _fields_and_field_types = {
        ...
        'returns': 'sequence<radar_msgs/RadarReturn>',
    }

    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['std_msgs', 'msg'], 'Header'),  # noqa: E501
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['radar_msgs', 'msg'], 'RadarReturn')),  # noqa: E501
    )
        ...
        if __debug__:
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 all(isinstance(v, RadarReturn) for v in value) and
                 True), \
                "The 'returns' field must be a set or sequence and each value of type 'RadarReturn'"
        self._returns = value
